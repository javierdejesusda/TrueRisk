"""add property_reports, geocode_cache, arpsi_flood_zones, municipalities tables
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("province_code", sa.String(2), sa.ForeignKey("provinces.ine_code"), index=True, nullable=False),
        sa.Column("latitude", sa.Float(), nullable=False),
        sa.Column("longitude", sa.Float(), nullable=False),
        sa.Column("population", sa.Integer(), nullable=True),
        sa.Column("area_km2", sa.Float(), nullable=True),
        sa.Column("elevation_m", sa.Float(), nullable=True),
        sa.Column("is_coastal", sa.Boolean(), server_default="false"),
        ...
        sa.Column("is_mediterranean", sa.Boolean(), server_default="false"),
