"""Heatwave risk TFT -- multi-horizon probabilistic forecast."""
...
_tft = HazardTFT("heatwave")


def predict_heatwave_risk_tft(
    history_sequence: list[dict], static_features: dict
) -> dict | None:
    """Multi-horizon heatwave forecast. Returns None if TFT unavailable."""
