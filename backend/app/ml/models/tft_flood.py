"""Flood risk TFT -- multi-horizon probabilistic forecast."""
...
_tft = HazardTFT("flood")


def predict_flood_risk_tft(
    history_sequence: list[dict], static_features: dict
) -> dict | None:
    """Multi-horizon flood forecast. Returns None if TFT unavailable."""
