"""Wildfire risk TFT -- multi-horizon probabilistic forecast."""
...
_tft = HazardTFT("wildfire")


def predict_wildfire_risk_tft(
    history_sequence: list[dict], static_features: dict
) -> dict | None:
    """Multi-horizon wildfire forecast. Returns None if TFT unavailable."""
