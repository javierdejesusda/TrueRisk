...
export const Evacuation: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg }}>
      <BrowserFrame src="prod-evacuation.png" title="truerisk.cloud — Evacuation Routes" tiltX={6} tiltY={5} oscillationSpeed={0.022} oscillationAmplitude={2.0} scaleFrom={0.91} />
